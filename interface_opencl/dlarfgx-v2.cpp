                  ...
                  magma_queue_t queue)
{
    ...
    ckKernel = rt->KernelPool["magma_dlarfgx_gpu_kernel"];
    if (!ckKernel)
    {
                   ...
                   magma_queue_t queue)
{
   ...
   if (i==0){
      ...
      magma_dsetmatrix(1, 1, &tt, 0, 1, dx0, dx0_offset, 1, queue);
   }
   else
   {
      ...
      cl_int ciErrNum;                // Error code var
      cl_kernel ckKernel=NULL;
      ckKernel = rt->KernelPool["magma_dgemv_kernel3"];     // in dlarfbx.cl
      ...
      ckKernel = rt->KernelPool["magma_dtrmv_kernel2"];         // in dlarfx.cl

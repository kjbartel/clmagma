...
__kernel void ztranspose3_32( __global magmaDoubleComplex *B, int offsetB, int ldb, 
...
__kernel void ztranspose2_32( __global magmaDoubleComplex *B, int offsetB, int ldb, 
                                __global magmaDoubleComplex *A, int offsetA, int lda, 
                                int m, int m32, int n, int n32)
{        
        __local magmaDoubleComplex a[32][ZSIZE_1SHARED+1];

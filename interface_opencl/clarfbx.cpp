                  ...
                  magma_queue_t queue)
{
    ...
    ckKernel = rt->KernelPool["magma_cgemv_kernel1"];   // in clarfbx.cl
    if (!ckKernel)
    {
    ...
    ckKernel = rt->KernelPool["magma_ctrmv_tkernel"];   // in clarfx.cl
    if (!ckKernel)
    {
        printf ("Error: cannot locate kernel in line %d, file %s\n", __LINE__, __FILE__);
        return MAGMA_ERR_UNKNOWN;
    ...
    ckKernel = rt->KernelPool["magma_cgemv_kernel2"];   // in clarfbx.cl
    if (!ckKernel)
    {
        printf ("Error: cannot locate kernel in line %d, file %s\n", __LINE__, __FILE__);
        return MAGMA_ERR_UNKNOWN;

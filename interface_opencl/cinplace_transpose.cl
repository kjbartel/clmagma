/*
    -- clMAGMA (version 0.3.0) --
       ...
       @generated c Wed Jun 27 23:49:55 2012
...
//	iby *= NB;
	...
	{
		__global magmaFloatComplex *B = matrix + iby + inx + __mul24( ibx + iny, lda );
...
{        
       ...
       //__local magmaFloatComplex b[NB][NB+1];
        ...
        __global magmaFloatComplex *A = matrix + ibx + inx + __mul24( iby + iny, lda );

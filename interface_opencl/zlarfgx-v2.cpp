...
magma_zlarfgx_gpu(int n, magmaDoubleComplex_ptr dx0, size_t dx0_offset, magmaDoubleComplex_ptr dx, size_t dx_offset,  
                  ...
                  magma_queue_t queue)
{
    ...
    ckKernel = rt->KernelPool["magma_zlarfgx_gpu_kernel"];
    if (!ckKernel)
    {
    ...
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&dx0 );
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&dx0_offset     );
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&dx   );
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&dx_offset );
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&dtau     );
    ...
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&dA     );
                   ...
                   magma_queue_t queue)
{
   ...
   if (i==0){
      ...
      magma_zsetmatrix(1, 1, &tt, 0, 1, dx0, dx0_offset, 1, queue);
   }
   else
   {
      ...
      cl_int ciErrNum;                // Error code var
      cl_kernel ckKernel=NULL;
      ckKernel = rt->KernelPool["magma_zgemv_kernel3"];     // in zlarfbx.cl
      ...
      ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&dx0 );
      ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&dx0_offset     );
      ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&work );
      ...
      ckKernel = rt->KernelPool["magma_ztrmv_kernel2"];         // in zlarfx.cl
      ...
      ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&T1 );

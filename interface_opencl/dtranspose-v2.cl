/*
    -- clMAGMA (version 0.3.0) --
       ...
       @generated d Thu Jun 28 19:26:36 2012
...
__kernel void dtranspose3_32( __global double *B, int offsetB, int ldb, 
                                __global double *A, int offsetA, int lda,
                                int m, int m32, int n, int n32)
{
         __local double a[32][DSIZE_1SHARED+1];
...
__kernel void dtranspose2_32( __global double *B, int offsetB, int ldb, 
                                __global double *A, int offsetA, int lda, 
                                int m, int m32, int n, int n32)
{        
        __local double a[32][DSIZE_1SHARED+1];

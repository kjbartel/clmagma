/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated from zlaswp.cpp normal z -> d, Sat Nov 15 00:21:35 2014
    ...
    magma_queue_t queue )
{
    ...
    kernel = g_runtime.get_kernel( "dlaswp_kernel" );
...
magmablas_dlaswpx(
    magma_int_t n,
    magmaDouble_ptr dA, size_t dA_offset, magma_int_t ldx, magma_int_t ldy,
    magma_int_t k1, magma_int_t k2,
    const magma_int_t *ipiv, magma_int_t inci,
    magma_queue_t queue )
{
    ...
    kernel = g_runtime.get_kernel( "dlaswpx_kernel" );
    ...
    magma_queue_t queue )
{
    ...
    size_t threads[1] = { NTHREADS };
    grid[0] *= threads[0];
    kernel = g_runtime.get_kernel( "dlaswp2_kernel" );
    if ( kernel != NULL ) {
        err = 0;
        i   = 0;
        err |= clSetKernelArg( kernel, i++, sizeof(n            ), &n             );

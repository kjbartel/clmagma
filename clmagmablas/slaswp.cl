/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated from zlaswp.cl normal z -> s, Sat Nov 15 00:21:35 2014
...
__kernel void slaswp_kernel(
    int n, __global float *dAT, unsigned long dAT_offset, int ldda, slaswp_params_t params )
{
    dAT += dAT_offset;
...
__kernel void slaswpx_kernel(
    int n, __global float *dA, unsigned long dA_offset, int ldx, int ldy, slaswp_params_t params )
{
    dA += dA_offset;
...
__kernel void slaswp2_kernel(
    int n, __global float *dAT, unsigned long dAT_offset, int ldda, int npivots,

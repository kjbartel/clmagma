/*
    -- MAGMA (version 1.3.0) --
       ...
       @author Mark Gates
       @generated from zlanhe.cl normal z -> s, Sat Nov 15 00:21:35 2014
...
slansy_inf_kernel_generic_lower(
    int n, const __global float* A, unsigned long A_offset, int lda, 
    ...
    int n_full_block, int n_mod_bs )
{
    ...
    __local float la[inf_bs][inf_bs+1];

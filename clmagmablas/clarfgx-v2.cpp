/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlarfgx-v2.cpp normal z -> c, Sat Nov 15 00:21:35 2014
                  ...
                  magma_queue_t queue)
{
    ...
    ckKernel = g_runtime.get_kernel( "magma_clarfgx_gpu_kernel" );
    if (!ckKernel)
    {
    ...
    ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaFloatComplex_ptr), (void*)&dx   );
                   ...
                   magma_queue_t queue)
{
   ...
   if (i==0){
      ...
      magma_csetmatrix(1, 1, &tt, 1, dx0, dx0_offset, 1, queue);
   }
   else
   {
      ...
      cl_int ciErrNum;                // Error code var
      cl_kernel ckKernel=NULL;
      ckKernel = g_runtime.get_kernel( "magma_cgemv_kernel3" );     // in clarfbx.cl
      ...
      ckKernel = g_runtime.get_kernel( "magma_ctrmv_kernel2" );         // in clarfx.cl

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlascl_2x2.cpp normal z -> s, Sat Nov 15 00:21:35 2014
    ...
    magma_int_t *info, magma_queue_t queue )
{
    *info = 0;
    ...
    if (type == MagmaLower) {
      ckKernel = g_runtime.get_kernel( "slascl_2x2_lower_kernel" );
    }
    else {
      ckKernel = g_runtime.get_kernel( "slascl_2x2_upper_kernel" );
    }

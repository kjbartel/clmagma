                  ...
                  magma_queue_t queue)
{
    ...
    ckKernel = g_runtime.get_kernel( "magma_zlarfgx_gpu_kernel" );
    if (!ckKernel)
    {
                   ...
                   magma_queue_t queue)
{
   ...
   else
   {
      ...
      cl_int ciErrNum;                // Error code var
      cl_kernel ckKernel=NULL;
      ckKernel = g_runtime.get_kernel( "magma_zgemv_kernel3" );     // in zlarfbx.cl
      ...
      ckKernel = g_runtime.get_kernel( "magma_ztrmv_kernel2" );         // in zlarfx.cl

/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated from ztranspose.cl normal z -> s, Sat Nov 15 00:21:35 2014
...
stranspose_kernel(
    int m, int n,
    const __global float *A, unsigned long A_offset, int lda,
    __global float *AT, unsigned long AT_offset,      int ldat)
{
    A += A_offset;
    AT += AT_offset;

    __local float sA[NB][NX+1];

...
__kernel void zlaswp_kernel(
    int n, __global magmaDoubleComplex *dAT, unsigned long dAT_offset, int ldda, zlaswp_params_t params )
{
    dAT += dAT_offset;
...
__kernel void zlaswpx_kernel(
    int n, __global magmaDoubleComplex *dA, unsigned long dA_offset, int ldx, int ldy, zlaswp_params_t params )
{
    dA += dA_offset;
...
__kernel void zlaswp2_kernel(
    int n, __global magmaDoubleComplex *dAT, unsigned long dAT_offset, int ldda, int npivots,

...
/*  -- clMAGMA (version 1.3.0) --
   ...
   =====================================================================    */
    ...
    if (m%BLK_M!=0 || n%BLK_N!=0) {
        ...
        ckKernel = g_runtime.get_kernel( "magmablas_zgemm_reduce_kernel" );
        if (!ckKernel)
        {
        ...
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex), (void*)&alpha );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&d_A     );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&d_A_offset   );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&lda );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&d_B     );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&d_B_offset   );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(int), (void*)&ldb );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex), (void*)&beta     );
        ciErrNum |= clSetKernelArg( ckKernel, nn++, sizeof(magmaDoubleComplex_ptr), (void*)&d_C     );

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from dznrm2.cl normal z -> c, Sat Nov 15 00:21:35 2014
*/
...
void sum_reduce(int n,  int i, __local float* x );  // prototype to suppress compiler warning
...
magmablas_scnrm2_kernel( int m, __global magmaFloatComplex *da, int da_offset, int ldda, __global float *dxnorm, int dxnorm_offset )
{
    ...
    //magmaFloatComplex *dx = da + get_group_id(0) * ldda;

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlarfbx.cl normal z -> c, Sat Nov 15 00:21:35 2014
...
void zsum_reduce(int n, int i, __local magmaFloatComplex* x );  // prototype to suppress compiler warning

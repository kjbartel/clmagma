/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zgemm_reduce.cl normal z -> s, Sat Nov 15 00:21:35 2014
*/
...
void sum_reduce3d( int n, int j, int k, int i, __local float* x );  // prototype to suppress compiler warning
void sum_reduce3d( int n, int j, int k, int i, __local float* x )
{
                                   ...
                                   __global float *d_C, int d_C_offset, int ldc)
{
        ...
        */
        ...
        sum_reduce3d(BLK_K,  get_local_id(1), get_local_id(2), i, (__local float*) sum );

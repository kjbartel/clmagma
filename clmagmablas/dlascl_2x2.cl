/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlascl_2x2.cl normal z -> d, Sat Nov 15 00:21:35 2014
...
__kernel void dlascl_2x2_full_kernel(
    int m, 
    __global const double* W, int offset_W, int ldw, 
...
__kernel void dlascl_2x2_lower_kernel(
    int m,
    __global const double* W, int offset_W, int ldw,
    __global double* A, int offset_A, int lda)
{
...
__kernel void dlascl_2x2_upper_kernel(
    int m,
    __global const double* W, int offset_W, int ldw,
    __global double* A, int offset_A, int lda)
{

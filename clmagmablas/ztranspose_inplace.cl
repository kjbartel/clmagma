...
__kernel void ztranspose_inplace_odd( int n, __global magmaDoubleComplex *matrix, unsigned long matrix_offset, int lda )
{
...
__kernel void ztranspose_inplace_even( int n, __global magmaDoubleComplex *matrix, unsigned long matrix_offset, int lda )
{
    matrix += matrix_offset;

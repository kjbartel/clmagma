...
#else
#define DEVPTR(__ptr) ((magmaDoubleComplex_ptr)(uintptr_t)((__ptr)))
#endif
...
*/
/*
void MAGMAF_ZGEBRD( magma_int_t *m, magma_int_t *n, magmaDoubleComplex *A, 
...
void MAGMAF_ZGEHRD( magma_int_t *n, magma_int_t *ilo, magma_int_t *ihi,
                    ...
                    magmaDoubleComplex_ptr d_T, size_t d_T_offset, magma_int_t *info, magma_queue_t queue )
{
...
void MAGMAF_ZGEQRF( magma_int_t *m, magma_int_t *n, magmaDoubleComplex *A, 
...
void MAGMAF_ZGETRF( magma_int_t *m, magma_int_t *n, magmaDoubleComplex *A, 
...
*/
// void MAGMAF_ZLATRD( char *uplo, magma_int_t *n, magma_int_t *nb, magmaDoubleComplex *a, 
...
*/
/*
void MAGMAF_ZPOTRF( char *uplo, magma_int_t *n, magmaDoubleComplex *A, 
...
*/
/*
void MAGMAF_ZHETRD( char *uplo, magma_int_t *n, magmaDoubleComplex *A, 
                    magma_int_t *lda, double *d, double *e, 
...
void MAGMAF_ZGEQRF_GPU( magma_int_t *m, magma_int_t *n, 
                        ...
                        magmaDoubleComplex *tau, devptr_t *dT, 
                        magma_int_t *info)
{
...
void MAGMAF_ZLABRD_GPU( magma_int_t *m, magma_int_t *n, magma_int_t *nb, 
                        magmaDoubleComplex *a, magma_int_t *lda, devptr_t *da, magma_int_t *ldda,
                        double *d, double *e, magmaDoubleComplex *tauq, magmaDoubleComplex *taup,  
                        magmaDoubleComplex *x, magma_int_t *ldx, devptr_t *dx, magma_int_t *lddx, 
                        magmaDoubleComplex *y, magma_int_t *ldy, devptr_t *dy, magma_int_t *lddy)
{
...
void MAGMAF_ZUNGQR_GPU( magma_int_t *m, magma_int_t *n, magma_int_t *k, 
                        devptr_t *da, magma_int_t *ldda, 
                        magmaDoubleComplex *tau, devptr_t *dwork, 
                        magma_int_t *nb, magma_int_t *info )
{
...
void MAGMAF_ZUNMQR_GPU( char *side, char *trans, 
                        magma_int_t *m, magma_int_t *n, magma_int_t *k,
                        devptr_t *a,    magma_int_t *lda, magmaDoubleComplex *tau, 

...
extern "C"
void zpanel_to_q(magma_uplo_t uplo, int ib, magmaDoubleComplex *A, int lda, magmaDoubleComplex *work)
{
    int i, j, k = 0;
...
extern "C"
void zq_to_panel(magma_uplo_t uplo, int ib, magmaDoubleComplex *A, int lda, magmaDoubleComplex *work)
{
    int i, j, k = 0;
    magmaDoubleComplex *col;

/*
    -- MAGMA (version 1.1.0-beta2) --
       ...
       @author Mark Gates
       @generated s Mon Nov 25 17:55:51 2013
*/
...
extern "C"
void spanel_to_q(magma_uplo_t uplo, int ib, float *A, int lda, float *work)
{
    int i, j, k = 0;
    float *col;
...
extern "C"
void sq_to_panel(magma_uplo_t uplo, int ib, float *A, int lda, float *work)
{
    int i, j, k = 0;
    float *col;

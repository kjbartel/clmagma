/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zposv_gpu.cpp normal z -> s, Sat Nov 15 00:21:37 2014
*/
...
/*  -- clMagma (version 0.1) --
    ...
    *info = 0;
    ...
    magma_spotrf_gpu( uplo, n, dA, 0, ldda, queue, info );
    if ( *info == 0 ) {
        magma_spotrs_gpu( uplo, n, nrhs, dA, 0, ldda, dB, 0, lddb, queue, info );
    }

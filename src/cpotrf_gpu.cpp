/*
     -- clMAGMA (version 1.3.0) --
        ...
        @generated from zpotrf_gpu.cpp normal z -> c, Sat Nov 15 00:21:37 2014
    ...
    if ((nb <= 1) || (nb >= n)) {
        ...
        if ( uplo == MagmaUpper ) {
            ...
            for( j = 0; j < n; j += nb ) {
                ...
                magma_cgetmatrix_async( jb, jb, dA(j,j), ldda, work, jb, queue, &event );
                ...
                magma_csetmatrix_async( jb, jb, work, jb, dA(j,j), ldda, queue, &event );

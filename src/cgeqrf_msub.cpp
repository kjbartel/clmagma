/*
   ...
   @generated from zgeqrf_msub.cpp normal z -> c, Sat Nov 15 00:21:37 2014
    ...
    *info = 0;
    ...
    if (nb >= nbmin && nb < k && nx < k) {
        ...
        for (i = 0; i < k-nx; i += nb) {
            ...
            lapackf77_cgeqrf(&rows, &ib, hwrk(i), &ldwork, tau+i, lhwrk, &lhwork, info);
            ...
            cpanel_to_q( MagmaUpper, ib, hwrk(i), ldwork, lhwrk+ib*ib );
            ...
            for (j=0; j<num_gpus; j++) {  
                ...
                /* Send the T matrix to the GPU. 
                   Has to be done with asynchronous copies */
                magma_csetmatrix_async( ib, ib, lhwrk, ib,
                                        dwork[j], 0, lddwork, 
                                        queues[2*j+1], NULL );
            }
            ...
            if (i + ib < n) {
                 if (i+nb < k-nx) {
                    ...
                    /* Restore the panel */
                    cq_to_panel( MagmaUpper, ib, hwrk(i), ldwork, lhwrk+ib*ib );
                } else {

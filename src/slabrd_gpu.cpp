/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlabrd_gpu.cpp normal z -> s, Sat Nov 15 00:21:37 2014
    ...
    if (m >= n) {
        ...
        for (i__ = 1; i__ <= nb; ++i__) {
            ...
            if (i__ < n) {
                ...
                i__2 = m - i__ + 1;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_one, &a[i__ + a_dim1],
                ...
                i__2 = m - i__ + 1;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_one, &x[i__ + x_dim1],
                ...
                #endif
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_neg_one, &a[(i__ + 1) *
                ...
                i__2 = n - i__;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__, &c_one, &y[i__ + 1 + y_dim1],
        ...
        for (i__ = 1; i__ <= nb; ++i__) {
            ...
            #endif
            i__3 = n - i__ + 1;
            blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_neg_one, &a[i__ * a_dim1 + 1],
            ...
            if (i__ < m) {
                ...
                i__2 = n - i__ + 1;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_one, &y[i__ + y_dim1],
                ...
                i__2 = m - i__;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__3, &c_one, &a[i__ + 1 + a_dim1],
                ...
                i__2 = m - i__;
                blasf77_sgemv(MagmaConjTransStr, &i__2, &i__, &c_one, &x[i__ + 1 + x_dim1],
                ...
                i__2 = n - i__;
                blasf77_sgemv(MagmaConjTransStr, &i__, &i__2, &c_neg_one,

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zunmqr.cpp normal z -> d, Sat Nov 15 00:21:37 2014
...
/*  -- MAGMA (version 1.3.0) --
    ...
    *info = 0;
    ...
    if (nb >= k) {
        /* Use CPU code */
        lapackf77_dormqr(lapack_const(side), lapack_const(trans), &m, &n, &k, &a[a_offset], &lda, &tau[1],
        ...
        for (i__ = i1; i3 < 0 ? i__ >= i2 : i__ <= i2; i__ += i3) {
            ...
            magma_dsetmatrix( i__4, ib, &a[i__ + i__ * lda], lda, dwork, 0, i__4, queue );

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zlahru.cpp normal z -> d, Sat Nov 15 00:21:37 2014
...
magma_dlahru(
    ...
    magmaDouble_ptr d_a, size_t d_a_offset, magma_int_t ldda,
    magmaDouble_ptr y, size_t y_offset, magma_int_t lddy,
    magmaDouble_ptr v, size_t v_offset,  magma_int_t lddv,
    magmaDouble_ptr d_t, size_t d_t_offset,
    magmaDouble_ptr d_work, size_t d_work_offset,
    magma_queue_t queue)
{
/*  -- clMAGMA auxiliary routine (version 0.1) --
    ...
    /* Update matrix M -= V0 T V' through
       1. d_work = T V'
       2. M -= V0 d_work                  */
    magma_dgemm( MagmaNoTrans, MagmaConjTrans, nb, ihi-k, nb,
    ...
    magma_dgetmatrix( k, nb, d_a, d_a_offset, ldda, a, lda, queue );
    ...
    magma_dgemm( MagmaConjTrans, MagmaNoTrans, ihi-k, n-k-nb, nb,

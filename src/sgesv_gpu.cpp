/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from zgesv_gpu.cpp normal z -> s, Sat Nov 15 00:21:37 2014
*/
...
/*  -- clMagma (version 0.1) --
    ...
    *info = 0;
    ...
    magma_sgetrf_gpu( n, n, dA, dA_offset, ldda, ipiv, queue, info);
    if ( *info == 0 ) {
        magma_sgetrs_gpu( MagmaNoTrans, n, nrhs, dA, dA_offset, ldda, ipiv, dB, dB_offset, lddb, queue, info );
    }

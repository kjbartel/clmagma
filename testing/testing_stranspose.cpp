/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated from testing_ztranspose.cpp normal z -> s, Sat Nov 15 00:21:40 2014
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_ssetmatrix( N, M, h_B, ldb, d_B, 0, lddb, opts.queue );
            ...
            //magmablas_stranspose( M-2, N-2, d_A+1+ldda, 0, ldda, d_B+1+lddb, 0, lddb, opts.queue );  // inset by 1 row & col
            magmablas_stranspose( M, N, d_A, 0, ldda, d_B, 0, lddb, opts.queue );
            ...
            if ( M == N ) {
                ...
                //magmablas_stranspose_inplace( N-2, d_A+1+ldda, 0, ldda, opts.queue );  // inset by 1 row & col
                magmablas_stranspose_inplace( N, d_A, 0, ldda, opts.queue );

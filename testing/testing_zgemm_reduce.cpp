    ...
    for( i=istart; i<iend; i = (int)(i*1.25) ) {
        for( int cnt = 0; cnt < count; ++cnt ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_zsetmatrix( Am, An, h_A, lda, d_A, 0, ldda, queue );
            magma_zsetmatrix( Bm, Bn, h_B, ldb, d_B, 0, lddb, queue );
            magma_zsetmatrix( M, N, h_C, ldc, d_C, 0, lddc, queue );
            ...
            magma_zgetmatrix( M, N, d_C, 0, lddc, h_C2, ldc, queue );
            ...
            magma_zgetmatrix( M, N, d_C, 0, lddc, h_C3, ldc, queue );

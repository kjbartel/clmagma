/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgehrd.cpp normal z -> s, Sat Nov 15 00:21:40 2014
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sgehrd( N, ione, N, h_R, lda, tau, h_work, lwork, dT, 0, opts.queue, &info );
            ...
            if ( opts.check ) {
                ...
                magma_sorghr( N, ione, N, h_Q, lda, tau, dT, 0, nb, opts.queue, &info );
                if (info != 0) {

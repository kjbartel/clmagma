/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zposv_gpu.cpp normal z -> s, Sat Nov 15 00:21:40 2014
*/
// includes, system
#include <stdio.h>
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_ssetmatrix( N, N,         h_A, N, d_A, 0, ldda, opts.queue );
            magma_ssetmatrix( N, opts.nrhs, h_B, N, d_B, 0, lddb, opts.queue );
            
            /* ====================================================================
               Performs operation using MAGMA
               =================================================================== */
            gpu_time = magma_wtime();
            magma_sposv_gpu( opts.uplo, N, opts.nrhs, d_A, 0, ldda, d_B, 0, lddb, opts.queue, &info );
            ...
            /* =====================================================================
               Residual
               =================================================================== */
            magma_sgetmatrix( N, opts.nrhs, d_B, 0, lddb, h_X, ldb, opts.queue );

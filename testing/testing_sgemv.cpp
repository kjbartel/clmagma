...
{        
    ...
    TESTING_MALLOC_HOST( A, float, szeA );
    TESTING_MALLOC_HOST( X, float, szeX );
    TESTING_MALLOC_HOST( Y, float, szeY );
    TESTING_MALLOC_HOST( Ymagma, float, szeY );
    TESTING_MALLOC_HOST( Ycpu, float, szeY );

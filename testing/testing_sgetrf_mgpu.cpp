/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgetrf_mgpu.cpp normal z -> s, Sat Nov 15 00:21:40 2014
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    magma_int_t dev, k, ngpu, n_local, nb, nk, ldn_local;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sgetrf_mgpu( ngpu, M, N, d_lA, 0, ldda, ipiv, queues, &info );

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgetri_gpu.cpp normal z -> c, Sat Nov 15 00:21:40 2014
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_csetmatrix( N, N, h_A, lda, d_A, 0, ldda, opts.queue );
            magma_cgetrf_gpu( N, N, d_A, 0, ldda, ipiv, opts.queue, &info );
            magma_cgetmatrix( N, N, d_A, 0, ldda, h_A, lda, opts.queue );
            if ( info != 0 )
            ...
            magma_cgetri_gpu( N, d_A, 0, ldda, ipiv, dwork, 0, ldwork, opts.queues2, &info );
            ...
            magma_cgetmatrix( N, N, d_A, 0, ldda, h_R, lda, opts.queue );

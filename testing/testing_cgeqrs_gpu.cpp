 ...
 *     @date November 2014
 *
 * @generated from testing_zgeqrs_gpu.cpp normal z -> c, Sat Nov 15 00:21:40 2014
 *
 **/
...
//#if defined(PRECISION_s)
    ...
    for(i=0; i<7; i++){
        ...
        magma_csetmatrix( M, N,    h_A, lda, d_A, 0, ldda, queue );
        magma_csetmatrix( M, nrhs, h_B, ldb, d_B, 0, lddb, queue );
        ...
        magma_cgetmatrix( N, nrhs, d_B, 0, lddb, h_X, ldb, queue );

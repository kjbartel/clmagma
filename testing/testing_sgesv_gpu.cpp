 ...
 *     April 2011
 *
 * @generated s Wed Jun 27 23:49:58 2012
 *
 **/
// includes, system
#include <stdlib.h>
...
int main(int argc , char **argv)
{
    ...
    if (argc != 1){
        ...
        printf("\nUsage: \n");
        printf("  testing_sgesv_gpu -N <matrix size> -R <right hand sides>\n\n");
    }
   ...
   // ldda = N;
	...
	//	ldda = N;
		...
		magma_sgesv_gpu( N, NRHS, dA, 0, ldda, ipiv, dB, 0, lddb, &info, queue );

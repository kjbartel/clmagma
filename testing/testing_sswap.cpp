/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zswap.cpp normal z -> s, Sat Nov 15 00:21:40 2014
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            time = magma_sync_wtime( queue );
            magma_ssetvector( nb, (float*)ipiv, 1, d_ipiv(0), 1, opts.queue ); // TODO fix to magma_[i]setvector !!!!!

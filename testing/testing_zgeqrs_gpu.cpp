...
//#if defined(PRECISION_s)
    ...
    TESTING_MALLOC_PIN( h_B,  magmaDoubleComplex, ldb*nrhs );
    TESTING_MALLOC_PIN( h_X,  magmaDoubleComplex, ldb*nrhs );
    TESTING_MALLOC_PIN( h_R,  magmaDoubleComplex, ldb*nrhs );

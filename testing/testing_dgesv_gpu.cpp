/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgesv_gpu.cpp normal z -> d, Sat Nov 15 00:21:40 2014
       @author Mark Gates
*/
// includes, system
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dsetmatrix( N, nrhs, h_B, ldb, d_B, 0, lddb, opts.queue );
            
            /* ====================================================================
               Performs operation using MAGMA
               =================================================================== */
            gpu_time = magma_wtime();
            magma_dgesv_gpu( N, nrhs, d_A, 0, ldda, ipiv, d_B, 0, lddb, opts.queue, &info );
            ...
            // Residual
            //=====================================================================
            magma_dgetmatrix( N, nrhs, d_B, 0, lddb, h_X, ldb, opts.queue );

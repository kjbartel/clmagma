...
int main( int argc, char** argv)
{
    ...
    for(i=0; i<10; i++){
        ...
        // warm-up
        magmablas_dsetmatrix_1D_bcyclic(M, N, h_R, lda, d_lA, ldda, tot_subs, nb, trans_queues);
        magma_dgeqrf_msub(num_subs, num_gpus, M, N, d_lA, ldda, tau, &info, queues);
        ...
        if (check == 1) {
            /* =====================================================================
               ...
               =================================================================== */
            magmablas_dgetmatrix_1D_bcyclic(M, N, d_lA, ldda, h_R, lda, tot_subs, nb, trans_queues);

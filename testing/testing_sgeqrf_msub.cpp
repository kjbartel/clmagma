/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgeqrf_msub.cpp normal z -> s, Sat Nov 15 00:21:40 2014
...
int main( int argc, char** argv)
{
    ...
    for(i=0; i<10; i++){
        ...
        // warm-up
        magma_ssetmatrix_1D_col_bcyclic(M, N, h_R, lda, d_lA, ldda, tot_subs, nb, trans_queues);
        magma_sgeqrf_msub(num_subs, num_gpus, M, N, d_lA, ldda, tau, queues, &info);
        ...
        if (check == 1) {
            /* =====================================================================
               ...
               =================================================================== */
            magma_sgetmatrix_1D_col_bcyclic(M, N, d_lA, ldda, h_R, lda, tot_subs, nb, trans_queues);

...
int main( int argc, char** argv) 
{
    ...
    if (argc != 1){
        ...
        printf("\nUsage: \n");
        printf("  testing_cpotrf2_gpu -N %d\n\n", 1024);
    }
    ...
    for(i=0; i<10; i++){
        ...
        magma_csetmatrix( N, N, hA, 0, lda, dA, 0, ldda, queue1);
        clFinish(queue1);
        magma_cpotrf2_gpu( MagmaLower, N, dA, 0, ldda, &info, queues );
        /* ====================================================================
        ...
        if (info != 0)
            printf( "magma_cpotrf2 had error %d.\n", info );
        ...
        /* =====================================================================
           ...
           =================================================================== */
        cpu_time = get_time();
        lapackf77_cpotrf( MagmaLowerStr, &N, hA, &lda, &info );
        ...
        /* =====================================================================
           ...
           =================================================================== */
        magma_cgetmatrix( N, N, dA, 0, ldda, hR, 0, lda, queue1 );

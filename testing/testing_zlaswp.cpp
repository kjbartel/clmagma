...
int main( int argc, char** argv) 
{
	...
	TESTING_MALLOC(h_A1, magmaDoubleComplex, n2);
	TESTING_MALLOC(h_A2, magmaDoubleComplex, n2);
	TESTING_MALLOC(h_A3, magmaDoubleComplex, n2);
	TESTING_MALLOC(h_AT, magmaDoubleComplex, n2);

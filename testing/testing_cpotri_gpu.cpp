/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zpotri_gpu.cpp normal z -> c, Sat Nov 15 00:21:40 2014
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_cpotrf_gpu( opts.uplo, N, d_A, 0, ldda, opts.queue, &info );
            
            // check for exact singularity
            //magma_cgetmatrix( N, N, d_A, 0, ldda, h_R, lda, opts.queue );
            //h_R[ 10 + 10*lda ] = MAGMA_C_MAKE( 0.0, 0.0 );
            //magma_csetmatrix( N, N, h_R, lda, d_A, 0, ldda, opts.queue );
            
            gpu_time = magma_wtime();
            magma_cpotri_gpu( opts.uplo, N, d_A, 0, ldda, opts.queues2, &info );

...
int main( int argc, char** argv)
{
    ...
    for( i = 0; i < ntest; ++i ) {
        ...
        magma_zsetmatrix( M, N, h_R, lda, d_A, 0, ldda, queue );
...
*/
        ...
        magma_zgeqr2x3_gpu( M, N, d_A, 0, ldda, dtau, 0, d_T, 0, ddA, 0, dwork, 0, queue, &info);
        ...
        if ( checkres ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_zgetmatrix( M, N, d_A, 0, ldda, h_R, M, queue );
            magma_zgetmatrix( N, N, ddA, 0, N,    h_T, N, queue );
            ...
            double terr = 0.;
            magma_zgetmatrix( N, N, d_T, 0, N, h_T, N, queue );

/*
    -- clMAGMA (version 1.3.0) --
       ...
       @generated from testing_zgeqrf2_gpu.cpp normal z -> d, Sat Nov 15 00:21:40 2014
...
int main( int argc, char** argv)
{
    ...
    if (argc != 1){
        ...
        if (M>0 && N>0)
            printf("  testing_dgeqrf2_gpu -M %d -N %d\n\n", M, N);
        else
            {
                printf("\nUsage: \n");
                printf("  testing_dgeqrf2_gpu -M %d -N %d\n\n", 1024, 1024);
    ...
    for(i=0; i<10; i++){
        ...
        /* ====================================================================
           ...
           =================================================================== */
        magma_dsetmatrix( M, N, h_R, lda, d_A, 0, ldda, queue1 );
        magma_dgeqrf2_2q_gpu( M, N, d_A, 0, ldda, tau, queues, &info);
        ...
        /* =====================================================================
           ...
           =================================================================== */
        magma_dgetmatrix( M, N, d_A, 0, ldda, h_R, M, queue1 );

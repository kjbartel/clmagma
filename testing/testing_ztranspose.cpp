...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_zsetmatrix( N, M, h_B, ldb, d_B, 0, lddb, opts.queue );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            magma_zsetmatrix( M, N, h_A, lda, d_A, 0, ldda, opts.queue );
            magma_zsetmatrix( N, M, h_B, ldb, d_B, 0, lddb, opts.queue );
            
            gpu_time = magma_sync_wtime( 0 );
            //magmablas_ztranspose( M-2, N-2, d_A+1+ldda, 0, ldda, d_B+1+lddb, 0, lddb, opts.queue );  // inset by 1 row & col
            magmablas_ztranspose( M, N, d_A, 0, ldda, d_B, 0, lddb, opts.queue );
            ...
            if ( M == N ) {
                ...
                //magmablas_ztranspose_inplace( N-2, d_A+1+ldda, 0, ldda, opts.queue );  // inset by 1 row & col
                magmablas_ztranspose_inplace( N, d_A, 0, ldda, opts.queue );

 ...
 *     April 2012
 *
 * @generated d Thu May 24 17:09:48 2012
 *
 **/
...
int main(int argc, char **argv)
{
    ...
    if (argc != 1){
        ...
        printf("\nUsage: \n");
        printf("  testing_dposv_gpu -N <matrix size> -R <right hand sides>\n\n");
    }
   ...
   // ldda = N;
	lddb = ldda;
    TESTING_MALLOC_HOST( hA, double, n2 );
    TESTING_MALLOC_HOST( hB, double, N*NRHS );
    TESTING_MALLOC_HOST( hX, double, N*NRHS );
	...
	//	ldda = N;
		...
		magma_dposv_gpu( MagmaUpper, N, NRHS, dA, 0, ldda, dB, 0, lddb, &info, queue );

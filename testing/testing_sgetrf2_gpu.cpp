...
int main( int argc, char** argv)
{
    ...
    if (argc != 1){
        ...
        if (M>0 && N>0)
            printf("  testing_sgetrf2 -M %d -N %d\n\n", M, N);
        else
            {
                printf("\nUsage: \n");
                printf("  testing_sgetrf2 -M %d -N %d\n\n", 1024, 1024);
        ...
        printf("\nUsage: \n");
        printf("  testing_sgetrf2_gpu -M %d -N %d\n\n", 1024, 1024);
        M = N = size[9];
    }
    ...
    for(i=0; i<10; i++){
        ...
        magma_sgetrf2_gpu( M, N, d_A, 0, ldda, ipiv, &info, queues );
        ...
        /* =====================================================================
           ...
           =================================================================== */
        magma_sgetmatrix( M, N, d_A, 0, ldda, h_A, 0, lda, queue );
